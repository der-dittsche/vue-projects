<template>
  ...
  >
    ...
    <div class="mb-3">
      ...
      <ErrorMessage class="text-red-600" name="contry" />
    </div>
    <!-- TOS -->
    <div class="mb-3 pl-6">
      <vee-field
  ...
  data() {
    return {
      schema: {
        ...
        contry: "required|excluded:Mexico",
        tos: "requiredtos",
      },
      userData: {
        contry: "Germany",
      ...
      reg_alert_msg: "Please wait! Your accoutn is being create",
    };
  },
  methods: {
    register(values) {
      ...
      this.reg_alert_msg = "Please wait! Your accoutn is being create";
      ...
      storeUsersData.addUserData(credentials);
